...
import PocketCodexPlugin from '@/main';

describe('PocketCodexPlugin', () => {
  let plugin: PocketCodexPlugin;
  let mockApp: any;
  ...
  beforeEach(() => {
    ...
    plugin = new PocketCodexPlugin(mockApp, mockManifest);
  ...
  describe('onload', () => {
    ...
    it('retries a pending provider invalidation after unload and restart', async () => {
      ...
      plugin.onunload();
      const restartedPlugin = new PocketCodexPlugin(mockApp, mockManifest);
  ...
  describe('loadSettings', () => {
    ...
    it("does not overwrite existing Pocket Codex plugin data with the legacy file", async () => {
      const legacyPath = '.obsidian/plugins/claudian-praetor/data.json';
    ...
    it('should merge saved data with defaults', async () => {
      // Mock claudian-settings.json exists with custom values (Pocket Codex-specific settings)
      mockApp.vault.adapter.exists.mockImplementation(async (path: string) => {
  ...
  describe('applyEnvironmentVariables', () => {
    ...
    it("restarts affected runtimes in every open Pocket Codex view", async () => {
      await plugin.onload();
  ...
  describe('new-tab command', () => {
    ...
    it("keeps tab commands unavailable while a Pocket Codex leaf view is not initialized", async () => {
      await plugin.onload();
