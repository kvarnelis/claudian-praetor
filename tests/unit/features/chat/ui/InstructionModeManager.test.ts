...
describe('InstructionModeManager', () => {
  it('should enter instruction mode on # keystroke when input is empty', () => {
    ...
    expect(wrapper.addClass).toHaveBeenCalledWith('pocket-codex-input-instruction-mode');
  });
  ...
  it('should exit instruction mode when input is cleared', () => {
    ...
    expect(wrapper.removeClass).toHaveBeenCalledWith('pocket-codex-input-instruction-mode');
  });
