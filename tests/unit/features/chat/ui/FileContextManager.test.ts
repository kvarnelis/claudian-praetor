...
describe('FileContextManager', () => {
  ...
  it('renders current note chip and removes on click', () => {
    ...
    const chip = findByClass(containerEl, 'pocket-codex-context-chip--note');
    expect(chip).toBeDefined();
    expect(containerEl.hasClass('has-content')).toBe(true);

    const removeEl = findByClass(containerEl, 'pocket-codex-context-chip-remove');
  ...
  it('shows vault-relative path in @ dropdown and inserts full path on selection', () => {
    ...
    const pathEl = findByClass(containerEl, 'pocket-codex-mention-path');
  ...
  it('wires getCachedVaultFolders through VaultFolderCache.getFolders', () => {
    ...
    const folderLabel = findByClass(containerEl, 'pocket-codex-mention-name-folder');
  ...
  it('filters context files and attaches absolute path', () => {
    ...
    const nameEls = findAllByClass(containerEl, 'pocket-codex-mention-name-context');
