...
describe('TabBar', () => {
  describe('constructor', () => {
    it('should add tab badges class to container', () => {
      ...
      expect(containerEl._classList.has('claudes-codex-tab-badges')).toBe(true);
    });
  });
  ...
  describe('badge rendering', () => {
    ...
    it('should toggle between index and title labels on double click', () => {
      ...
      expect(badge.hasClass('claudes-codex-tab-badge-expanded')).toBe(true);
      ...
      expect(badge.hasClass('claudes-codex-tab-badge-expanded')).toBe(false);
    ...
    it('should keep expanded title state across tab bar updates', () => {
      ...
      expect(containerEl._children[0].hasClass('claudes-codex-tab-badge-expanded')).toBe(true);
    });
  ...
  describe('badge state classes', () => {
    it('should apply idle class for inactive tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-idle')).toBe(true);
    });
    ...
    it('should apply active class for active tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-active')).toBe(true);
    });
    ...
    it('should apply streaming class for streaming tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-streaming')).toBe(true);
    });
    ...
    it('should apply attention class for tab needing attention', () => {
      ...
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-attention')).toBe(true);
    });
    ...
    it('should prioritize active over attention', () => {
      ...
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-active')).toBe(true);
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-attention')).toBe(false);
    });
    ...
    it('should prioritize attention over streaming', () => {
      ...
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-attention')).toBe(true);
      expect(containerEl._children[0]._classList.has('claudes-codex-tab-badge-streaming')).toBe(false);
    });
  ...
  describe('destroy', () => {
    ...
    it('should remove tab badges class from container', () => {
      ...
      expect(containerEl._classList.has('claudes-codex-tab-badges')).toBe(false);
    });
  });
});
