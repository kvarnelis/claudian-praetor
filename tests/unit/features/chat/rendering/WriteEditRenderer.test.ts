...
describe('WriteEditRenderer', () => {
  describe('createWriteEditBlock', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      expect(state.contentEl.hasClass('praetor-hidden')).toBe(true);
    ...
    it('should start expanded when requested', () => {
      ...
      expect(state.contentEl.hasClass('praetor-hidden')).toBe(false);
  ...
  describe('renderStoredWriteEdit', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      const block = renderStoredWriteEdit(parentEl, toolCall);
      const headerEl = block.querySelector('.praetor-write-edit-header');
      const contentEl = block.querySelector('.praetor-write-edit-content');

      expect(block.hasClass('expanded')).toBe(false);
      expect(contentEl?.hasClass('praetor-hidden')).toBe(true);
