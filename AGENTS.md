...
| Path | Contents |
| --- | --- |
| `.claudian/claudian-settings.json` | Shared Praetor settings and provider-specific configuration |
...
| `.claude/mcp.json` | Praetor-managed MCP servers for Claude |
...
Claudian. Do not rename or migrate them: Praetor must continue reading existing
