 ...
 * all providers: Pocket Codex settings, tab manager state, and session metadata.
 *
...
export interface SharedAppStorage {
  initialize(): Promise<{ pocketCodex: Record<string, unknown> }>;
  savePocketCodexSettings(settings: Record<string, unknown>): Promise<void>;
