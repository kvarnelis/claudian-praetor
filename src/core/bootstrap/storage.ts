 ...
 * all providers: Praetor settings, tab manager state, and session metadata.
 *
...
export interface SharedAppStorage {
  initialize(): Promise<{ praetor: Record<string, unknown> }>;
  savePraetorSettings(settings: Record<string, unknown>): Promise<void>;
