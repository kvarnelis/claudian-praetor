...
export class McpServerModal extends Modal {
  ...
  onOpen() {
    ...
    this.modalEl.addClass('pocket-codex-mcp-modal');
    ...
    this.typeFieldsEl = contentEl.createDiv({ cls: 'pocket-codex-mcp-type-fields' });
    this.renderTypeFields();
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'pocket-codex-mcp-buttons' });
    ...
    const saveBtn = buttonContainer.createEl('button', {
      ...
      cls: 'pocket-codex-save-btn mod-cta',
    });
  ...
  private renderStdioFields() {
    ...
    cmdSetting.settingEl.addClass('pocket-codex-mcp-cmd-setting');

    const cmdTextarea = cmdSetting.controlEl.createEl('textarea', {
      cls: 'pocket-codex-mcp-cmd-textarea',
    });
    ...
    envSetting.settingEl.addClass('pocket-codex-mcp-env-setting');

    const envTextarea = envSetting.controlEl.createEl('textarea', {
      cls: 'pocket-codex-mcp-env-textarea',
    });
  ...
  private renderUrlFields() {
    ...
    headersSetting.settingEl.addClass('pocket-codex-mcp-env-setting');
