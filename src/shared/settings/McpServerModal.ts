...
export class McpServerModal extends Modal {
  ...
  onOpen() {
    ...
    this.modalEl.addClass('claudes-codex-mcp-modal');
    ...
    this.typeFieldsEl = contentEl.createDiv({ cls: 'claudes-codex-mcp-type-fields' });
    this.renderTypeFields();
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'claudes-codex-mcp-buttons' });
    ...
    const saveBtn = buttonContainer.createEl('button', {
      ...
      cls: 'claudes-codex-save-btn mod-cta',
    });
  ...
  private renderStdioFields() {
    ...
    cmdSetting.settingEl.addClass('claudes-codex-mcp-cmd-setting');

    const cmdTextarea = cmdSetting.controlEl.createEl('textarea', {
      cls: 'claudes-codex-mcp-cmd-textarea',
    });
    ...
    envSetting.settingEl.addClass('claudes-codex-mcp-env-setting');

    const envTextarea = envSetting.controlEl.createEl('textarea', {
      cls: 'claudes-codex-mcp-env-textarea',
    });
  ...
  private renderUrlFields() {
    ...
    headersSetting.settingEl.addClass('claudes-codex-mcp-env-setting');
