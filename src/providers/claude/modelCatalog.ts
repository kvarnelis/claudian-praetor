...
// Families whose 1M variant is a Claudian-side toggle rather than a CLI-listed model
 ...
 * fetch. The CLI lists most-capable-first; Claudian stores ascending capability
