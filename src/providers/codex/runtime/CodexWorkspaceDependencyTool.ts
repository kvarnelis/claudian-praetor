...
export function createCodexWorkspaceDependencyTool(
  ...
  return {
    ...
    namespace: {
      ...
      description: 'Tools provided by the Praetor Codex host.',
    },
    tool: {
      type: 'function',
      name: CODEX_WORKSPACE_DEPENDENCY_TOOL_NAME,
      description: 'Locate the configured bundled workspace dependency runtime paths for this local Praetor Codex thread, including Node.js, Python, and useful libraries for working with spreadsheets, slide decks, Word documents, and PDFs. This is read-only and takes no arguments.',
      inputSchema: {
        type: 'object',
        properties: {},
