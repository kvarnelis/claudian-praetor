...
export class CodexSubagentSettings {
  ...
  async render(): Promise<void> {
    ...
    headerEl.createSpan({ text: t('settings.codexSubagents.header'), cls: 'pocket-codex-sp-label' });
  ...
  private renderItem(listEl: HTMLElement, agent: CodexSubagentDefinition): void {
    ...
    if (agent.model) {
      headerRow.createSpan({ text: agent.model, cls: 'pocket-codex-slash-item-badge' });
    }
