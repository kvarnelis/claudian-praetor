...
export class ImageContextManager {
  ...
  constructor(
    ...
    const ownedTrayContainer = contextTray
      ? null
      : (previewContainerEl ?? containerEl).createDiv({ cls: 'pocket-codex-context-row' });
  ...
  private setupDragAndDrop() {
    const inputWrapper = this.containerEl.querySelector('.pocket-codex-input-wrapper') as HTMLElement;
    if (!inputWrapper) return;

    this.dropOverlay = inputWrapper.createDiv({ cls: 'pocket-codex-drop-overlay' });
    const dropContent = this.dropOverlay.createDiv({ cls: 'pocket-codex-drop-content' });
  ...
  private handleDragLeave(e: DragEvent) {
    ...
    const inputWrapper = this.containerEl.querySelector('.pocket-codex-input-wrapper');
    if (!inputWrapper) {
  ...
  private setupAttachButton() {
    ...
    button.className = 'pocket-codex-image-attach-btn';
    ...
    fileInput.className = 'pocket-codex-hidden';
